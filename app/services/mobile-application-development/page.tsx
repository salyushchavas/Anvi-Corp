...
export const metadata: Metadata = {
  ...
  description:
    "ANVI mobile application development: iOS, Android, and cross-platform apps engineered for performance, usability, and reach.",
};
...
export default function MobileAppDevelopmentPage() {
  return (
    <ServicePageTemplate
      ...
      heading="Achieve mobile excellence with ANVI Mobile Application Development"
      intro="In today's mobile-first world, having a powerful and engaging mobile application is crucial. Anvi Corp specializes in developing robust mobile applications that deliver exceptional user experiences."
