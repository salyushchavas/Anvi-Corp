...
export const metadata: Metadata = {
  ...
  description: `${BRAND_SHORT} software development services: custom, end-to-end software built on advanced technologies for startups and large enterprises.`,
};
...
export default function SoftwareDevelopmentPage() {
  return (
    <ServicePageTemplate
      ...
      heading={`Advancing your digital transformation with ${BRAND_SHORT} Software Development`}
      intro={`At ${BRAND.name}, we recognize the critical role software plays in driving business success. Our comprehensive ${BRAND_SHORT} software development services are meticulously designed to meet the unique needs of your organisation — whether you're a startup or a large enterprise.`}
