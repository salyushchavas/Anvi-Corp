...
const FAQS: { q: string; a: string }[] = [
  ...
  { q: 'Do I need a GitHub account for projects?',
    a: 'A GitHub account is optional. If you have one, you can add your username in Profile settings so it shows on your project page. Project repositories are public — clone them and push your work to your own GitHub when you submit.' },
