...
const STAFF_ROLE_LINKS: Record<UserRole, StaffLink[]> = {
  INTERN: [
    ...
    { icon: FileSignature,  label: 'Offer Letter',      href: '/careers/intern/offer-letter', moduleKey: 'offerLetter' },
  ...
  ERM: [
    ...
    { icon: Video,          label: 'Upload Interview',     href: '/careers/erm/upload-interview-recording' },
    { icon: FolderArchive,  label: 'Recording Gallery',    href: '/careers/erm/recording-gallery' },
    { icon: Video,          label: 'Recording Sessions',   href: '/careers/erm/evaluation-recordings' },
