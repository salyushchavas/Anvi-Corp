...
/** Trainer to-do panel + login pop-up gate feed. */
@RestController
@RequestMapping("/api/v1/trainer/todos")
@RequiredArgsConstructor
public class TrainerTodoController {

    private final TrainerTodoService service;
